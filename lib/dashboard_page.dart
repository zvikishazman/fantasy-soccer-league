          ...
          builder: (BuildContext context, BoxConstraints constraints) {
            ...
            return Row(
              children: <Widget>[
                if (wide)
                  _DesktopNavigation(
                      selectedIndex: _selectedIndex, onSelect: _select),
                Expanded(
                  child: CustomScrollView(
                    slivers: <Widget>[
                      SliverPadding(
                        padding: EdgeInsets.fromLTRB(
                            wide ? 42 : 20, 24, wide ? 42 : 20, 44),
      ...
      bottomNavigationBar: MediaQuery.sizeOf(context).width < 920
          ? NavigationBar(
              ...
              destinations: const <NavigationDestination>[
                ...
                NavigationDestination(
                    icon: Icon(Icons.groups_outlined), label: 'Squad'),
                NavigationDestination(
                    icon: Icon(Icons.leaderboard_outlined), label: 'Table'),
                NavigationDestination(
                    icon: Icon(Icons.tune_outlined), label: 'Admin'),
              ],
            )
          : null,
    );
      ...
      children: <Widget>[
        DecoratedBox(
          ...
          child: Padding(
              ...
              child:
                  Icon(Icons.sports_soccer, color: AppColors.navy, size: 23)),
        ),
        SizedBox(width: 12),
        Text('Fantasy\nSoccer',
            style: TextStyle(
                fontSize: 18, height: 1.05, fontWeight: FontWeight.w800)),
      ],
    );
  }
}
          ...
          children: <Widget>[
              ...
              children: <Widget>[
                ...
                DecoratedBox(
                  ...
                  child: Padding(
                    ...
                    child: Text('${scoring.teamPoints(demoTeam)} pts',
                        style: const TextStyle(
            ...
            Container(
              ...
              child: Wrap(
                ...
                spacing: 8,
                runSpacing: 18,
                children: demoTeam.players.map((Player player) {
                  return _PlayerChip(
                      player: player,
...
class _PlayerChip extends StatelessWidget {
  const _PlayerChip(
      {required this.player, required this.captain, required this.scoring});
              ...
              children: demoTeam.players.map((Player player) {
                return ListTile(
                  ...
                  title: Text(player.name,
                      style: const TextStyle(fontWeight: FontWeight.w700)),
                  subtitle:
                      Text('${player.positionLabel} · Value ${player.value}'),
                  trailing: Text(
                      '${scoring.playerPoints(player, isCaptain: player.id == demoTeam.captainId)} pts',
                      style: const TextStyle(
                          color: AppColors.mint, fontWeight: FontWeight.w900)),
                );
              }).toList(growable: false),
            ),
          ),
          ...
          child: Padding(
            ...
            child: Column(
                children: demoStandings
                    .map(
                        (Standing standing) => _StandingRow(standing: standing))
                    .toList(growable: false)),
          ),
        ),
      ],
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        Wrap(
          spacing: 16,
          runSpacing: 16,
          children: workflows.map(((IconData, String, String) item) {
            return SizedBox(
              width: 320,
              child: Card(
                child: Padding(
